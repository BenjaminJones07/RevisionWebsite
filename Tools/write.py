...
db.execute("INSERT INTO questions (question, answers, ansNo, reason, subj, topic) VALUES (?, ?, ?, ?, ?, ?)", question[0].upper() + question[1:], ';'.join(answers), rand+1, reason if reason.replace(" ", "") != "" else None, subj, topic)
