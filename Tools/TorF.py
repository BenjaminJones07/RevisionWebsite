...
# Database write
db.execute("INSERT INTO questions (question, answers, ansNo, reason, subj, topic) VALUES (?, 'True;False', ?, ?, ?, ?)", question[0].upper() + question[1:], isTrue, reason if reason.replace(" ", "") != "" else None, subj, topic)
